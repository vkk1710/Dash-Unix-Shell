...
compilationFlags = ["-Wall -Werror -O -std=gnu99"]
...
def testCase1():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'1.in'}"
...
def testCase2():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'2.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase3():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'3.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase4():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'4.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase5():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'5.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase6():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'6.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase7():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'7.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase8():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'8.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase9():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'does_not_exist.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase10():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'10.in'} {TEST_CASES_PATH+'case'+'10.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase11():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'11.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase12():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'12.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase13():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'13.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase14():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'14.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase15():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'15.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase16():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'16.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase17():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'17.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase18():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'18.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase19():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'19.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase20():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'20.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase21():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'21.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase22():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'22.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase23():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'23.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase24():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'24.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase25():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'25.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase26():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'26.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase27():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'27.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase28():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'28.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase29():
    ...
    command = f"./dash < {TEST_CASES_PATH+'case'+'29.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase30():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'30.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=TEST_TIMEOUT)
...
def testCase31():
    ...
    command = f"./dash {TEST_CASES_PATH+'case'+'31.in'}"
    returnCode, output, error = runCommandWithTimeout(command, timeout=(TEST_TIMEOUT+0))
...
totalScore = totalScore + testCase12() # TEST_CASE_13
